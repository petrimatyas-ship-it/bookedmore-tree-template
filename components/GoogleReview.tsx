...
export function GoogleReviewCard({
  ...
  return (
    <article
      className={`flex h-full flex-col rounded-[14px] border border-forest-900/10 bg-white p-5 shadow-[0_10px_30px_rgba(18,49,25,0.07)] ${className}`}
    >
...
export function GoogleRatingSummary({
  ...
  return (
    <div className={`rounded-[14px] border border-forest-900/10 bg-white p-5 ${className}`}>
