      ...
      >
        {config.phone && (
          <a
            ...
            className="inline-flex h-12 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl bg-forest-700 px-2 text-[13px] font-bold text-white shadow-lg shadow-forest-900/20"
          >
