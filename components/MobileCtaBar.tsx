...
export function MobileCtaBar({
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-x-0 bottom-0 z-40 grid gap-2 border-t border-white/10 bg-night/95 p-2.5 pb-[max(0.625rem,env(safe-area-inset-bottom))] backdrop-blur lg:hidden ${
      ...
      >
        {config.phone && (
          <a
            ...
            className="inline-flex h-12 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl bg-lime px-2 text-[13px] font-bold text-night shadow-lg"
          >
