...
export function OwnerNote({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <aside
      className={`flex items-start gap-2.5 rounded-[12px] border border-dashed border-ember-500/45 bg-ember-500/[0.07] px-4 py-3 text-sm leading-6 text-forest-900/80 ${className}`}
    >
